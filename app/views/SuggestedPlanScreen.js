...
import { Container, Header, Title, Content, Form, Item, Label, Input, ListItem, List, H1, Card, CardItem, Thumbnail, Image, Footer, FooterTab, Button, Left, Right, Body, Icon, Text } from 'native-base';
